    ...
    <form onSubmit={handleSubmit} className="bg-white p-6 rounded shadow-md w-80">
        <div className="mb-2 relative">
            ...
            <Input
                ...
                className={`border ${errors.email ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-indigo-500'} rounded px-2 py-1`}
            />
        ...
        <div className="mb-2 relative">
            ...
            <Input
                ...
                className={`border ${errors.password ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-indigo-500'} rounded px-2 py-1`}
            />
